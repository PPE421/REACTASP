  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900  shadow-md">
      <div className="container mx-auto px-4 py-8">
        <div className="rounded-lg shadow-md p-6 max-w-lg mx-auto  bg-gray-100 dark:bg-gray-900 ">
          ...
          <div className="mb-6">
            ...
            <div className="p-4 rounded  bg-gray-100 dark:bg-gray-900  shadow-md">
          ...
          <div className="mb-6">
            ...
            {loading ? (
              ...
              <div>
                <div className="p-4 rounded mb-4  bg-gray-100 dark:bg-gray-800  shadow-md">
